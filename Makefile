...
doc:
	...
	pandoc -c /assets/custom.css -s -B _includes/banner.html -A _includes/footer.html perso/projects/PredictiveCodingforSpeech/Project.md -t html --mathjax -o perso/projects/PredictiveCodingforSpeech/Project.html
